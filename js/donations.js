  ...
  return `
    <div class="my-donation-card fade-in" id="mycard-${food.id}">
      ...
      <div class="my-donation-footer">
        ...
        <button class="btn btn-outline btn-sm" data-action="edit" data-id="${food.id}">✏️ Editar</button>
        ...
        <button class="btn btn-danger btn-sm" data-action="delete" data-id="${food.id}">🗑️ Remover</button>
      </div>
    </div>`;
}
